...
Harmes Agent - Medical AI Project
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/Harmes-Agent.git
cd Harmes-Agent
```
...
1. **构建镜像**
```bash
docker build -t Harmes-Agent .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name Harmes-Agent Harmes-Agent
```
...
- **项目主页**: https://github.com/MoKangMedical/Harmes-Agent
- **问题反馈**: https://github.com/MoKangMedical/Harmes-Agent/issues
